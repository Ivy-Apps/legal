...
**Refund Policy:** All purchases are final and **non-refundable** unless required by applicable law.
...
- **Users are advised to critically evaluate all AI-generated content and not use it as a substitute for professional advice. Ivy Apps Ltd is not responsible for any consequences resulting from the use or misuse of AI-generated content.**
- **Ivy Apps Ltd does not endorse or approve any AI-generated content. The views and opinions expressed in AI-generated content do not necessarily reflect those of Ivy Apps Ltd.**
...
- **The anonymized data collected by Firebase Analytics and Crashlytics is used solely for improving the App's performance and stability. Ivy Apps Ltd does not attempt to identify individual users from this data.**
- **Ivy Apps Ltd uses industry-standard practices for anonymizing data but cannot guarantee absolute anonymity. The user accepts this inherent risk by using the App.**
...
The App is provided on an **"as is"**, **"as available"**, and **"with all faults"** basis. To the fullest extent permitted by law, Ivy Apps Ltd disclaims all warranties, including:
...
- **Due to the complex nature of software and AI technology, Ivy Apps Ltd cannot guarantee that the App will be error-free or uninterrupted. The user acknowledges this limitation and accepts the App's functionality on an 'as is' basis.**
...
- **To the fullest extent permitted by law, Ivy Apps Ltd's liability is limited to direct damages only. Ivy Apps Ltd shall not be liable for any indirect, incidental, consequential, or punitive damages, even if Ivy Apps Ltd has been advised of the possibility of such damages.**
- **In jurisdictions where limitations on liability are not permitted, Ivy Apps Ltd's liability shall be limited to the minimum amount permitted by law.**
...
All rights, titles, and interests in the App (excluding third-party APIs and generated outputs) are owned by Ivy Apps Ltd. You may not reproduce, modify, distribute, or create derivative works without our prior written consent.

---

## 10. Termination

You may stop using the App at any time. We reserve the right to suspend or terminate access at our discretion if you breach these Terms.

---

## 11. Governing Law and Dispute Resolution

These Terms shall be governed by the laws of **Bulgaria**. Any disputes shall be subject to the exclusive jurisdiction of the Bulgarian courts. Nothing in these Terms limits your rights under consumer protection laws of your local jurisdiction if applicable.

---

## 12. Changes to These Terms

We may modify these Terms from time to time. Significant changes will be communicated through the App or via email with at least **30 days’ notice**. Your continued use after the effective date constitutes your acceptance of the revised Terms.
- **The user is responsible for checking for updates to the ToS periodically. While Ivy Apps will provide 30-day notice, it's the user's responsibility to stay informed.**
---
...
---
**Beta Features:**
The App may contain beta features that are still under development. These features may be unstable and may not function as expected. Ivy Apps Ltd is not responsible for any issues arising from the use of beta features.
